...
nnoremap('n', '<leader>e', telescope.find_files)
nnoremap('n', '<leader>g', telescope.live_grep)
nnoremap('n', '<leader>f', telescope.buffers) -- Open file explorer
nnoremap("n", "<leader>n", ":Neotree toggle <CR>", silent)
nnoremap('n', '<leader>x', ':bd<CR>', silent)
--[[
